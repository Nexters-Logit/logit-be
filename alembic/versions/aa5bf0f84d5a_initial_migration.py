...
Revision ID: aa5bf0f84d5a
Revises: 
Create Date: 2026-01-20 16:15:08.712282
...
def upgrade() -> None:
    ...
    sa.Column('employment_type', sqlmodel.sql.sqltypes.AutoString(length=100), nullable=True),
    sa.Column('recruit_notice', sa.Text(), nullable=True),
