...
## 지시사항
1. 사용자 요청이 자기소개서 초안 작성/재작성 요청인지 판단하세요.
   - True (초안 생성): "써줘", "작성해줘", "만들어줘", "새로 써줘", "다시 써줘"
   - False (대화): 피드백 요청, 질문, 특정 부분 수정, 첨삭, 조언
...
3. [보조 경험]은 한 문장 이내로 자연스럽게 녹여 넣으세요. how_to_mention이 "언급 안 함"인 경험은 절대 포함하지 마세요.
